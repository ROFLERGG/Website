export default {
	...
	emote: {
		...
		delete_prompt: {
			heading: "{0}-ის წაშლა",
			heading_versions: "{1}-ის '{0}' ვერსიის წაშლა",
			notice: "დარწმუნებული ხართ, რომ გსურთ {0} ემოუთის წაშლა{'?'}",
			notice_versions: "დარწმუნებული ხართ, რომ გსურთ წაშალოთ ვერსია '{0}' {1}-დან{'?'}",
			reason: "წაშლის მიზეზი",
		},
		unlisted: {
			heading: "ყურადღება!",
